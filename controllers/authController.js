  ...
  try {
    ...
    const mailOptions = {
      ...
      html: `
        ...
        <p>Hi,</p>
        <p>Your one-time password for <b>BEYINC SIGNUP</b> is <b>${otp.toString()}</b> valid for the next 2 minutes. For safety reasons, <b>PLEASE DO NOT SHARE YOUR OTP</b> with anyone. </p>
